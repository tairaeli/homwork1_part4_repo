...
def main():
    """
    Runs each of the above functions
    """
    print("\nStarting our calculation. Would be strange if something broke here\n")

    stencil_points = 5  # points in the stencil used for our numerical
                        # derivative in the secant method
    guess = -2.0        # initial guess for our root finder
    max_iters = 20      # maximum number of iterations for secant and trapezoidal methods
